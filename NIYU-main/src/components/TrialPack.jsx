...
export default function TrialPack() {
  ...
  return (
    <section className="relative py-6 px-4 sm:px-6 overflow-hidden" aria-label="Trial pack offer">
      <div className="absolute inset-0 bg-gradient-to-r from-charcoal via-dark-brown to-charcoal" />
