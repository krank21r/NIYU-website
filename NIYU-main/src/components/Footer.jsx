...
export default function Footer() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-b from-ink to-charcoal" />
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        ...
        >
          <div className="text-3xl md:text-4xl font-heading font-bold gold-gradient mb-4 tracking-[0.3em]">
            NIYU
          </div>
          <div className="w-12 h-[1px] bg-gold/30 mx-auto my-6" aria-hidden="true" />
          <p className="text-sm md:text-base text-champagne/50 font-elegant italic max-w-lg mx-auto leading-relaxed mb-8">
          ...
          <p className="text-xs text-champagne/30 font-body font-light tracking-wider">
