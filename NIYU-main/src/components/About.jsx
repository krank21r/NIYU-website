...
const cards = [
  {
    ...
    description:
      'At NIYU, every fragrance is lovingly crafted by hand. We draw inspiration from nature, traditions, and emotions to create perfumes and attars that feel personal, soulful, and timeless. Each bottle carries the essence of artistry and authenticity.',
    icon: (
  ...
  },
  {
    ...
    description:
      'Luxury shouldn\'t be out of reach. NIYU brings premium, chemical-free perfumes and attars to everyone who values elegance and purity. Our mission is to make indulgence accessible — offering refined fragrances at fair prices without compromising quality.',
    icon: (
      <svg className="w-8 h-8 text-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  ...
  },
  {
    ...
    description:
      'We promise uncompromising quality in every drop. Using pure oils, alcohol bases, and eco-friendly methods, NIYU ensures long-lasting scents that are safe, natural, and memorable. Our perfumes are more than fragrances — they\'re experiences you can trust.',
    icon: (
      <svg className="w-8 h-8 text-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -right-4 w-16 md:w-24 h-16 md:h-24 border-r border-b border-gold/20" />
            <div className="absolute -top-4 -left-4 w-16 md:w-24 h-16 md:h-24 border-l border-t border-gold/20" />
          </div>
