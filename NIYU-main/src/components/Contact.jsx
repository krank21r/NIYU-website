...
function ContactCard({ contact, index }) {
  ...
  return (
    ...
    >
      <div className="double-bezel-inner p-6 md:p-8 flex items-start gap-5">
        <div className="p-3 rounded-xl bg-gold/8 group-hover:bg-gold/12 transition-colors duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] shrink-0 text-gold">
          {contact.icon}
        </div>
        <div>
          ...
          <p className="text-base md:text-lg text-ink-soft group-hover:text-gold transition-colors duration-700 font-body">
            {contact.value}
          </p>
        </div>
      </div>
...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative py-24 sm:py-36 px-4 sm:px-6">
      ...
      >
        ...
        <div className="relative w-14 h-14 rounded-full bg-gold flex items-center justify-center shadow-lg shadow-gold/20 hover:shadow-gold/40 transition-shadow duration-500">
