...
export default function AnnouncementBar() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-[55] bg-charcoal overflow-hidden flex items-center" style={{ height: 'calc(2.25rem + env(safe-area-inset-top, 0px))', paddingTop: 'env(safe-area-inset-top, 0px)' }}>
      <motion.div
