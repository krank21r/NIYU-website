      ...
      <div className="relative aspect-square bg-surface-soft overflow-hidden">
        ...
        >
          <motion.svg
            ...
            className={`w-4 h-4 transition-colors ${wished ? 'text-red-500' : 'text-ink-subtle'}`}
            fill={wished ? 'currentColor' : 'none'} viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}
          >
