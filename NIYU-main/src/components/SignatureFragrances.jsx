...
function FragranceCard({ fragrance, index }) {
  ...
  return (
    <motion.article
      ...
      className="group border border-ink/5 bg-cream hover:border-ink/10 transition-all duration-300 cursor-pointer active:scale-[0.98]"
    >
      <div className="p-6 min-h-[460px] flex flex-col justify-between">
        ...
        <div className="flex justify-center items-center mb-4 flex-1">
          <img
            ...
            width="200"
            height="280"
            className="h-44 md:h-52 w-auto object-contain opacity-80 group-hover:opacity-100 transition-all duration-500 ease-[var(--ease-out)] group-hover:scale-105"
          />
        </div>

        {/* Info */}
        <div>
          <div className="w-8 h-[1px] bg-ink/30 group-hover:w-16 transition-all duration-500 ease-[var(--ease-out)] mb-4" />
          <h3 className="text-xl md:text-2xl font-heading text-ink-soft group-hover:text-ink transition-colors duration-300 mb-2">
            {fragrance.name}
          </h3>
          <p className="text-ink-subtle font-body font-light text-xs leading-relaxed group-hover:text-ink-muted transition-colors duration-300 mb-4">
          ...
          <button
            ...
            className="w-full py-3 bg-ink/10 hover:bg-ink text-ink hover:text-white text-[11px] tracking-[0.1em] uppercase font-body font-medium transition-all duration-200 ease-[var(--ease-out)] min-h-[44px] active:scale-[0.97]"
