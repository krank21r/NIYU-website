  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 text-center overflow-y-auto h-full">
      ...
      <motion.div
        ...
        className="w-full max-w-sm rounded-xl bg-cream/40 border border-ink/5 p-5 mb-6 text-left"
      >
      ...
      >
        ...
        <button
          ...
          className="w-full py-3 rounded-full bg-[#25D366] hover:bg-[#128C7E] text-white text-[11px] tracking-[0.1em] uppercase font-body font-semibold transition-all duration-400 flex items-center justify-center gap-2 min-h-[44px]"
        >
        ...
        <button
          onClick={closeFlow}
          className="mt-3 w-full py-3 rounded-full border border-ink/10 text-ink-muted text-[11px] tracking-[0.08em] uppercase font-body font-medium hover:border-gold/30 transition-all duration-400 min-h-[44px]"
        >
          Continue Shopping
        </button>
      </motion.div>
